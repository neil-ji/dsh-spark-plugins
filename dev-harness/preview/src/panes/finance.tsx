/**
 * 财务审计卡（真 FinanceCard，含 dashboard + 配置编辑 + 价格同步 + Provider 视图）
  ...
  return (
    <div className="pv-frame pv-wide">
      <p className="pv-hint">
        ...
        内存 <code>settingsScope('finance')</code>。改字段会立刻出现 override 徽标，保存/还原走内存层（刷新即复原）。
      </p>
      <FinanceCard {...injected.card} defaultOpen />
    </div>
  )
}
