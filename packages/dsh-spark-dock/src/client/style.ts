...
export const DOCK_CSS = [
  ...
  '[data-plugin="dsh-spark-dock"] .dock-graph-node-active { fill: var(--spk-brand); stroke: var(--spk-surface-card); stroke-width: 1.5; }',
  ...
  '[data-plugin="dsh-spark-dock"] .dock-graph-edge-derived { stroke: var(--spk-acc-spark); }',
  ...
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot-active { background: var(--spk-brand); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot-archived { background: var(--spk-label-3); }',
  ...
  '[data-plugin="dsh-spark-dock"] .dock-graph-line-derived { background: var(--spk-acc-spark); }',
