...
export const DOCK_CSS = [
  ...
  '[data-plugin="dsh-spark-dock"] .dock-badge { position: absolute; top: -4px; right: -4px; min-width: 18px; height: 18px; border-radius: 9px; padding: 0 4px; background: var(--spk-error); color: var(--spk-on-error); font: 700 var(--spk-text-xs)/18px var(--dsw-font-family, inherit); text-align: center; box-shadow: 0 0 0 2px var(--spk-surface-float); }',
