...
export const DOCK_CSS = [
  ...
  /* ── Graph 子页（关联图谱）── 节点/边取 token，与面板同色系 */
  '[data-plugin="dsh-spark-dock"] .dock-graph-summary { white-space: nowrap; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-wrap { display: flex; flex-direction: column; gap: var(--spk-gap-card, 8px); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-svg { width: 100%; height: auto; display: block; background: var(--spk-layer-2); border: 1px solid var(--spk-border); border-radius: var(--spk-radius-md); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node { cursor: pointer; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node:focus-visible { outline: 2px solid var(--spk-focus-ring); outline-offset: 2px; border-radius: var(--spk-radius-full); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node-pending { fill: var(--spk-brand); stroke: var(--spk-surface-card); stroke-width: 1.5; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node-crystallized { fill: var(--spk-acc-finance); stroke: var(--spk-surface-card); stroke-width: 1.5; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node-archived { fill: var(--spk-label-3); stroke: var(--spk-surface-card); stroke-width: 1.5; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-node-memory { fill: var(--spk-acc-hippomemo); stroke: var(--spk-surface-card); stroke-width: 1.5; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-edge { stroke-linecap: round; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-edge-tag { stroke: var(--spk-border-2); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-edge-proposal { stroke: var(--spk-brand-fg); stroke-dasharray: 5 3; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-edge-crystallized { stroke: var(--spk-acc-finance); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-tip { font: 500 var(--spk-text-xs) var(--spk-font); fill: var(--spk-label); paint-order: stroke; stroke: var(--spk-surface-card); stroke-width: 3px; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-legend { list-style: none; margin: 0; padding: 0; display: flex; flex-wrap: wrap; gap: var(--spk-space-2) var(--spk-space-4); font-size: var(--spk-text-xs); color: var(--spk-label-2); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-legend li { display: inline-flex; align-items: center; gap: var(--spk-space-2); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot { width: 9px; height: 9px; border-radius: var(--spk-radius-full); flex: none; }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot-pending { background: var(--spk-brand); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot-crystallized { background: var(--spk-acc-finance); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-dot-memory { background: var(--spk-acc-hippomemo); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-line { width: 18px; height: 2px; flex: none; background: var(--spk-border-2); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-line-proposal { background: repeating-linear-gradient(90deg, var(--spk-brand-fg) 0 5px, transparent 5px 8px); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-line-crystallized { background: var(--spk-acc-finance); }',
  '[data-plugin="dsh-spark-dock"] .dock-graph-error { margin: 0; color: var(--spk-error); font-size: var(--spk-text-sm); }',
