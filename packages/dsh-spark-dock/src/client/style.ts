...
export const DOCK_CSS = [
  ...
  '[data-plugin="dsh-spark-dock"] .dock-tab-badge { position: absolute; top: var(--spk-space-1, 4px); right: var(--spk-space-1, 4px); min-width: var(--spk-text-md); height: var(--spk-text-md); border-radius: var(--spk-radius-sm); padding: 0 var(--spk-space-1, 4px); background: var(--dsw-alias-state-error-primary); color: var(--dsw-alias-label-primary-foreground, #fff); font: 700 var(--spk-text-xs)/var(--spk-text-md) var(--dsw-font-family, inherit); text-align: center; box-shadow: 0 0 0 var(--spk-space-1, 4px) var(--dsw-alias-bg-module-platform); pointer-events: none; }',
  ...
  '[data-plugin="dsh-spark-dock"] .dock-btn { display: inline-flex; align-items: center; gap: 8px; height: var(--spk-control-h, 32px); padding: 0 var(--spk-radius-lg); border-radius: var(--spk-radius-md); border: none; background: var(--dsw-alias-button-primary-fill, var(--dsw-alias-brand-primary)); color: var(--dsw-alias-label-primary-foreground, #fff); font: 600 var(--spk-text-md)/1 var(--dsw-font-family, inherit); cursor: pointer; }',
  ...
  '[data-plugin="dsh-spark-dock"] .dock-field { width: 100%; box-sizing: border-box; background: var(--dsw-alias-bg-layer-2); border: 1px solid var(--spk-border-2, var(--dsw-alias-border-l1)); border-radius: var(--spk-radius-md); color: var(--dsw-alias-label-primary); font: 400 var(--spk-text-md)/1.4 var(--dsw-font-family, inherit); padding: var(--spk-space-2) var(--spk-space-3); margin-bottom: var(--spk-gap-card, 8px); }',
  '[data-plugin="dsh-spark-dock"] .dock-field:hover { border-color: var(--spk-label-3, var(--dsw-alias-border-l2)); }',
