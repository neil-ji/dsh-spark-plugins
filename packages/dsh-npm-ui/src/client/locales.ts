...
export const zh = {
  ...
  testConnection: '测试连接',
  testConnectionHint: '粘贴 granular token 后先测连通，再保存。',
  testing: '测试中…',
  testOk: '连接成功',
  testFail: '连接失败',
  testDone: '测试完成',
  ...
  tokenStatusFailed: 'token 状态读取失败（不影响上面的注册表信息）',
  published: '已发布',
  unpublished: '未发布',
  latest: '最新',
  packagesTitle: '套件包',
...
export const en: Record<NpmKey, string> = {
  ...
  testConnectionHint: 'Paste a granular token, test connectivity, then save.',
  testing: 'Testing…',
  testOk: 'Connected',
  ...
  tokenStatusFailed: 'Could not read the token status (the registry info above is unaffected)',
  published: 'Published',
