 ...
 *
 * 与 client.ts 入口的区别：无 window.__ModuleLoader__ banner/footer，
 * 不注册 settings.section / settings.plugin.item —— 纯组件 + controller +
 * 字典，由宿主（dock）自行 mount remote、构造 store 并注入 t。
 */
